    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <article className="max-w-4xl text-white bg-black pt-20  mx-auto px-6 py-12">
        ...
        <p className="text-lg mb-8">
          Instagram feels simple when you use it. You open the app, scroll
          through photos, watch a reel, send a message, and move on with your
          day. But behind that smooth experience is an engineering system built
          to handle hundreds of millions of people interacting at the same time.
        </p>

        <p className="mb-6">
          In this article, I will explain how Instagram is designed under the
          hood. My goal is to make it simple enough for anyone to understand,
          yet deep enough for someone interested in backend systems or cloud
          engineering.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4">The Heart of Instagram</h2>
        <p className="mb-4">
          At its core, Instagram is a read heavy system. For every photo
          uploaded, millions of people may view it. This means the architecture
          must make reading content extremely fast.
        </p>
        <p className="mb-6">
          Most of Instagrams speed comes from separating the work into layers.
          One layer handles user actions, another handles data, and another
          handles delivery. This separation helps the system scale as more
          people join.
        </p>
        ...
        <p className="mb-4">
          Instead of calculating the feed at the moment you refresh it, the
          system prepares it in the background. This idea is called fan out on
          write. Whenever someone uploads a post, Instagram starts preparing
          feed entries for that persons followers.
        </p>
        <p className="mb-6">
        ...
        <p className="mb-4">
          ...
          accessed data in memory. Reading from memory is far faster than
          reading from a database. This is why Instagram uses caching heavily
          for feed content, user profiles, reels, stories, and even comments.
        </p>
        <p className="mb-6">
        ...
        <p className="mb-4">
          ...
          quickly anywhere in the world. The solution is a global content
          delivery network.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-6">
          This design keeps Instagram responsive even for users far away from
          main data centers.
        </p>
        ...
        <p className="mb-6">
          ...
          lightweight connections and pushes updates the moment something
          happens.
        </p>
        ...
        <p className="mb-4">
          Every component is designed to scale horizontally. When more users
          join, more servers can be added. When new features launch, new
          microservices handle them. When data grows, storage is expanded across
          regions.
        </p>
        <p className="mb-6">
